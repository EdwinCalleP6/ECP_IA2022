...
def accion1():
    linea=('______________________________________\n')
    print(linea,'BIOGRAFIA:')
    biografia=['Mi nombre es Edwin, estoy cursando la materia SIS420, Inteligencia artificial de Carrera Ing. De Sistemas. En la USFX.',
    'Esta es la practica01 de la materia','y se esta imprimiendo esta informacion en visual code']
    print(biografia[0],biografia[1],biografia[2])

    print('MIS DATOS:')
    mis_datos={'Nombre':'Edwin','Apellidos':'Calle Perez','Carrera':'Ing. De Sistemas','programa':'visual code'}
